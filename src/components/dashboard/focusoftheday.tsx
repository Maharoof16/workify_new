       ...
       <CardContent className="px-4 py-3 flex flex-col gap-2">
        ...
        <div className="space-y-2">
          {focusData.map((item, index) => (
            <div
              key={index}
              className="flex items-center justify-between rounded-lg border border-[#E3ECF5] bg-white px-2 py-1"
            >
              ...
              <div className="flex items-center gap-3">
                ...
                {item.actions === "priority" && (
                  <button className="cursor-pointer rounded-xl bg-[#FFF1F1] px-4 py-2 text-sm font-medium text-[#F04438]">
                    High Priority
                  </button>
                )}
                ...
                {item.actions === "meeting" && (
                  <>
                    <button className="cursor-pointer rounded-xl border border-[#D6E4F2] bg-white px-4 py-2 text-sm font-medium text-[#1683E2] transition hover:bg-[#F7FAFF]">
                      Reschedule
                    </button>

                    <button className="cursor-pointer rounded-xl bg-[#1683E2] px-5 py-2 text-sm font-medium text-white transition hover:opacity-90">
                      Join
                    </button>
                  </>
                )}
